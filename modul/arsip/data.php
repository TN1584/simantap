...
<div class="card mt-3">
  ...
  <div class="card-body">
    <a href="?halaman=arsip_surat&hal=tambahdata" class="btn-dark mb-3">Tambah Data</a>
    ...
    <tr>
        ...
        <td>
            ...
            ?>
                 ...
                 <a href="file/<?=$data['file']?>" target="_blank" rel="noopener noreferrer">Lihat File</a>
